/**
 * Script to fix the src/pages/_app.js file
 */
...
const appFilePath = path.join(process.cwd(), 'src', 'pages', '_app.js');

// Check if the file exists
if (!fs.existsSync(appFilePath)) {
  console.error('Error: src/pages/_app.js does not exist');
  process.exit(1);
}
...
console.log('CSS import fixed in src/pages/_app.js');
