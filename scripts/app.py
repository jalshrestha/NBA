...
DATA_FILE = 'data/general/nba_data.json'
PLAYER_STATS_FILE = 'data/general/player_stats.json'
TEAM_STATS_FILE = 'data/general/team_stats.json'
STANDINGS_FILE = 'data/stats/standings.json'
LAST_UPDATE_FILE = 'data/config/last_update.txt'
...
def get_player_stats(player_id):
    ...
    try:
        ...
        cache_file = f"data/players/player_{player_id}_stats.json"
